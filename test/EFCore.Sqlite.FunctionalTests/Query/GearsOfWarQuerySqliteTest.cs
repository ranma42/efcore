...
FROM "Weapons" AS "w"
LEFT JOIN "Weapons" AS "w0" ON "w"."SynergyWithId" = "w0"."Id"
LEFT JOIN "Gears" AS "g" ON "w0"."OwnerFullName" = "g"."FullName"
LEFT JOIN "Gears" AS "g0" ON "w"."OwnerFullName" = "g0"."FullName"
WHERE CASE
...
""");
    ...
    public override async Task Navigation_based_on_complex_expression4(bool async)
    {
        ...
        AssertSql(
            """
SELECT 1, "l2"."Name", "l2"."Discriminator", "l2"."LocustHordeId", "l2"."ThreatLevel", "l2"."ThreatLevelByte", "l2"."ThreatLevelNullableByte", "l2"."DefeatedByNickname", "l2"."DefeatedBySquadId", "l2"."HighCommandId", "g"."Nickname", "g"."SquadId", "g"."AssignedCityName", "g"."CityOfBirthName", "g"."Discriminator", "g"."FullName", "g"."HasSoulPatch", "g"."LeaderNickname", "g"."LeaderSquadId", "g"."Rank", "g0"."Nickname", "g0"."SquadId", "g0"."AssignedCityName", "g0"."CityOfBirthName", "g0"."Discriminator", "g0"."FullName", "g0"."HasSoulPatch", "g0"."LeaderNickname", "g0"."LeaderSquadId", "g0"."Rank"
FROM "Factions" AS "f"
CROSS JOIN (
    SELECT "l"."DefeatedByNickname", "l"."DefeatedBySquadId"
    FROM "LocustLeaders" AS "l"
    WHERE "l"."Discriminator" = 'LocustCommander'
) AS "l0"
LEFT JOIN (
...
LEFT JOIN "Gears" AS "g" ON "l2"."DefeatedByNickname" = "g"."Nickname" AND "l2"."DefeatedBySquadId" = "g"."SquadId"
LEFT JOIN "Gears" AS "g0" ON "l0"."DefeatedByNickname" = "g0"."Nickname" AND "l0"."DefeatedBySquadId" = "g0"."SquadId"
""");
    }
    ...
    public override async Task Navigation_based_on_complex_expression5(bool async)
    {
        ...
        AssertSql(
            """
SELECT "l2"."Name" IS NOT NULL, "g"."Nickname", "g"."SquadId", "g"."AssignedCityName", "g"."CityOfBirthName", "g"."Discriminator", "g"."FullName", "g"."HasSoulPatch", "g"."LeaderNickname", "g"."LeaderSquadId", "g"."Rank", "g0"."Nickname", "g0"."SquadId", "g0"."AssignedCityName", "g0"."CityOfBirthName", "g0"."Discriminator", "g0"."FullName", "g0"."HasSoulPatch", "g0"."LeaderNickname", "g0"."LeaderSquadId", "g0"."Rank"
FROM "Factions" AS "f"
CROSS JOIN (
    SELECT "l"."DefeatedByNickname", "l"."DefeatedBySquadId"
    FROM "LocustLeaders" AS "l"
...
LEFT JOIN (
    SELECT "l1"."Name", "l1"."DefeatedByNickname", "l1"."DefeatedBySquadId"
    FROM "LocustLeaders" AS "l1"
    WHERE "l1"."Discriminator" = 'LocustCommander'
) AS "l2" ON "f"."CommanderName" = "l2"."Name"
LEFT JOIN "Gears" AS "g" ON "l2"."DefeatedByNickname" = "g"."Nickname" AND "l2"."DefeatedBySquadId" = "g"."SquadId"
...
""");
    ...
    public override async Task Navigation_based_on_complex_expression6(bool async)
    {
        ...
        AssertSql(
            """
SELECT "l2"."Name" = 'Queen Myrrah' AND "l2"."Name" IS NOT NULL, "g"."Nickname", "g"."SquadId", "g"."AssignedCityName", "g"."CityOfBirthName", "g"."Discriminator", "g"."FullName", "g"."HasSoulPatch", "g"."LeaderNickname", "g"."LeaderSquadId", "g"."Rank", "g0"."Nickname", "g0"."SquadId", "g0"."AssignedCityName", "g0"."CityOfBirthName", "g0"."Discriminator", "g0"."FullName", "g0"."HasSoulPatch", "g0"."LeaderNickname", "g0"."LeaderSquadId", "g0"."Rank"
FROM "Factions" AS "f"
CROSS JOIN (
    SELECT "l"."DefeatedByNickname", "l"."DefeatedBySquadId"
    FROM "LocustLeaders" AS "l"

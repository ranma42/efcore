...
""",
            ...
            """
SELECT "e"."Id", CASE
    WHEN "e"."NullableIntA" = "e"."IntB" THEN 1
    ELSE 0
END AS "X"
FROM "Entities1" AS "e"
""",
...
""",
            ...
            """
SELECT "e"."Id", CASE
    WHEN "e"."IntA" = "e"."NullableIntB" THEN 1
    ELSE 0
END AS "X"
FROM "Entities1" AS "e"
""",
...
""",
            ...
            """
SELECT "e"."Id", CASE
    WHEN "e"."NullableIntA" = "e"."IntB" THEN 0
    ELSE 1
END AS "X"
FROM "Entities1" AS "e"
""",
...
""",
            ...
            """
SELECT "e"."Id", CASE
    WHEN "e"."IntA" = "e"."NullableIntB" THEN 0
    ELSE 1
END AS "X"
FROM "Entities1" AS "e"
""",
...
""",
            ...
            """
SELECT "e"."Id", CASE
    WHEN "e"."BoolA" = "e"."NullableBoolB" THEN 1
    ELSE 0
END AS "X"
FROM "Entities1" AS "e"
""",
...
""",
            ...
            """
SELECT "e"."Id", CASE
    WHEN "e"."NullableBoolA" = "e"."BoolB" THEN 1
    ELSE 0
END AS "X"
FROM "Entities1" AS "e"
""",
...
""",
            ...
            """
SELECT "e"."Id", CASE
    WHEN "e"."NullableBoolA" = "e"."BoolB" THEN 0
    ELSE 1
END AS "X"
FROM "Entities1" AS "e"
""",
